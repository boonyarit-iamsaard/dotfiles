...
| --------------------------------------------------------- | --------------- |
| New tech, pattern, or integration not yet used in project | `⚠️ Likely`     |
| Multiple viable implementation approaches exist           | `⚠️ Likely`     |
...
| ------------------------------------------------------------------------ | ------------------ |
| Feature introduces new infrastructure, service, or deployment target     | `⚠️ Likely`        |
| Feature requires new environment variables, secrets, or pipeline changes | `⚠️ Likely`        |
